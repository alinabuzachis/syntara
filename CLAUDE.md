...
26. **No `// TODO` comments in shipped code** -- deferred work belongs in Jira, not buried in source. If a follow-up is needed, create a ticket and reference it inline (e.g., `// Inline type until AAP-12345`). See [`.claude/skills/coding_standards.md`](.claude/skills/coding_standards.md) §32
