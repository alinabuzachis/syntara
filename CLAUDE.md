...
10. **Extract shared patterns** — use `ConfirmationDialog`, `useDialogState`, `useDeleteAction`, `useCursorPagination`
...
| **Confirmation dialogs**            | [`.claude/skills/coding_standards.md`](.claude/skills/coding_standards.md) — `ConfirmationDialog` component (two-tier: permanent actions get `destructiveAcknowledgement` checkbox; reversible actions get warning icon only)                      |
