...
class AuditEventRecord(BaseResource, table=True):
    ...
    def from_event(cls, event: AuditEvent) -> "AuditEventRecord":
        ...
        return cls(
            ...
            actor_username=event.actor_username[: FieldLimits.NAME_MAX_LENGTH] if event.actor_username else None,
            source_component=event.source_component,
            resource_urn=event.resource_urn,
            resource_name=event.resource_name[: FieldLimits.NAME_MAX_LENGTH] if event.resource_name else None,
