...
from nexus.approvals.audit.approval import ApprovalRequestedEvent
from nexus.audit.handler import AuditEventHandler
from nexus.telemetry.client import get_telemetry_registry
from nexus.telemetry.events.approval import ApprovalRequestedEvent as ApprovalRequestedTelemetryEvent
