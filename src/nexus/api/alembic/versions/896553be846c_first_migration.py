...
Revision ID: 896553be846c
Revises:
Create Date: 2025-11-12 20:40:45.820158
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("creator", "approver", "administrator", "viewer", name="userrole", create_constraint=True),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("created", "running", "paused", "cancelled", "completed", "failed", name="invocationstatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column("created_by", sa.Uuid(), nullable=False),
        sa.Column("updated_by", sa.Uuid(), nullable=True),
        sa.Column("target_type", sa.Enum("PROVIDER", "TOOL", "USER", name="targettype"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("enabled", sa.Boolean(), nullable=False),
        sa.Column("status", sa.Enum("available", "error", "validating", name="tool_provider_status"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("enabled", sa.Boolean(), nullable=False),
        sa.Column("status", sa.Enum("available", "missing", "error", name="tool_status"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("string", "number", "boolean", "object", "array", name="tool_parameter_type"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "counter_type",
            sa.Enum("PROVIDER", "TOOL", "USER", "PROVIDER_USER", "TOOL_USER", name="countertype"),
            nullable=False,
        ),
        ...
        sa.Column("window_duration", sa.Enum("HOUR", "DAY", "MONTH", name="windowduration"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "pending", "running", "completed", "failed", "retrying", name="activitystatus", create_constraint=True
            ),
            nullable=False,
        ),
        sa.Column("started_at", sa.DateTime(timezone=True), nullable=True),
