...
# Use relative imports due to module execution pattern (python -m src.nexus.agents)
# When running as a module, PYTHONPATH is /app and module is src.nexus.agents
# Absolute imports like 'from nexus.agents.core' would fail with ModuleNotFoundError
