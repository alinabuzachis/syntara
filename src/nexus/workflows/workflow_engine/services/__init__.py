...
def __getattr__(name: str) -> Any:  # noqa: ANN401, PLR0911
    ...
    if name == "get_activity_sync_service":
        from nexus.workflows.workflow_engine.services.activity_sync_registry import (  # noqa: PLC0415
            get_activity_sync_service,
        )
    ...
    if name == "TemporalExecutionService":
        from nexus.workflows.workflow_engine.services.temporal_execution_service import (  # noqa: PLC0415
            TemporalExecutionService,
        )
    ...
    if name == "TemporalWorkerService":
        from nexus.workflows.workflow_engine.services.temporal_worker import (  # noqa: PLC0415
            TemporalWorkerService,
        )
    ...
    if name == "get_worker":
        from nexus.workflows.workflow_engine.services.temporal_worker import get_worker  # noqa: PLC0415

        return get_worker

    if name == "start_worker":
        from nexus.workflows.workflow_engine.services.temporal_worker import start_worker  # noqa: PLC0415

        return start_worker

    if name == "stop_worker":
        from nexus.workflows.workflow_engine.services.temporal_worker import stop_worker  # noqa: PLC0415
