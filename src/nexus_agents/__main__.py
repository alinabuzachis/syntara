...
Usage:
    ...
    python -m src.nexus_agents --agent generic-agent --port 8001
...
Examples:
  ...
  python -m src.nexus_agents --agent research-agent --postgres postgresql://user:pass@localhost:5432/db
