...
from ...models.resources_response_tool_with_parameters import ResourcesResponseToolWithParameters
...
) -> HTTPValidationError | ResourcesResponseToolWithParameters | None:
    if response.status_code == 200:
        response_200 = ResourcesResponseToolWithParameters.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | ResourcesResponseToolWithParameters]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | ResourcesResponseToolWithParameters
    """
