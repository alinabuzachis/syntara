...
from ...models.resources_response_tool_provider_with_configuration import ResourcesResponseToolProviderWithConfiguration
...
) -> HTTPValidationError | ResourcesResponseToolProviderWithConfiguration | None:
    if response.status_code == 200:
        response_200 = ResourcesResponseToolProviderWithConfiguration.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | ResourcesResponseToolProviderWithConfiguration]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | ResourcesResponseToolProviderWithConfiguration
    """
