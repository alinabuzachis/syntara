...
from ...models.tool_provider_list_response import ToolProviderListResponse
...
) -> ErrorData | ToolProviderListResponse | None:
    if response.status_code == 200:
        response_200 = ToolProviderListResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorData | ToolProviderListResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ErrorData | ToolProviderListResponse
    """
