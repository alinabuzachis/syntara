...
from ...models.resources_response_workflow_read import ResourcesResponseWorkflowRead
...
) -> HTTPValidationError | ResourcesResponseWorkflowRead | None:
    if response.status_code == 200:
        response_200 = ResourcesResponseWorkflowRead.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | ResourcesResponseWorkflowRead]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | ResourcesResponseWorkflowRead
    """
