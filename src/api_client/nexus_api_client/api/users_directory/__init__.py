...
class UsersDirectoryApi:
    """Registry for users_directory API endpoints."""
    ...
    def list(self, **kwargs: Any) -> Response[Any]:
        endpoint_module = self._load_endpoint_module("list_users_directory")
