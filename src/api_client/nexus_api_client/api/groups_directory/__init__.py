"""groups_directory API endpoints."""
...
class GroupsDirectoryApi:
    """Registry for groups_directory API endpoints."""
    ...
    def list(self, **kwargs: Any) -> Response[Any]:
        endpoint_module = self._load_endpoint_module("list_groups_directory")
