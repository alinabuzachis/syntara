...
T = TypeVar("T", bound="GroupRoleAssignmentRead")


@_attrs_define
class GroupRoleAssignmentRead:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        group_role_assignment_read = cls(
            id=id,
            group_id=group_id,
            group_name=group_name,
            role_name=role_name,
        ...
        group_role_assignment_read.additional_properties = d
        return group_role_assignment_read
