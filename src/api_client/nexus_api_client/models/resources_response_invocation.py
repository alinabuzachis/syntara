...
T = TypeVar("T", bound="ResourcesResponseInvocation")


@_attrs_define
class ResourcesResponseInvocation:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resources_response_invocation = cls(
            resources=resources,
            next_=next_,
            prev=prev,
            total=total,
        ...
        resources_response_invocation.additional_properties = d
        return resources_response_invocation
