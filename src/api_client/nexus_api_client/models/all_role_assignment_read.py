...
T = TypeVar("T", bound="AllRoleAssignmentRead")


@_attrs_define
class AllRoleAssignmentRead:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        all_role_assignment_read.additional_properties = d
        return all_role_assignment_read
