...
T = TypeVar("T", bound="ResourcesResponseApprovalRequest")


@_attrs_define
class ResourcesResponseApprovalRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resources_response_approval_request = cls(
            resources=resources,
            next_=next_,
            prev=prev,
            total=total,
        ...
        resources_response_approval_request.additional_properties = d
        return resources_response_approval_request
