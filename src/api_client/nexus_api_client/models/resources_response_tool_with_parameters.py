...
T = TypeVar("T", bound="ResourcesResponseToolWithParameters")


@_attrs_define
class ResourcesResponseToolWithParameters:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resources_response_tool_with_parameters = cls(
            resources=resources,
            next_=next_,
            prev=prev,
            total=total,
        ...
        resources_response_tool_with_parameters.additional_properties = d
        return resources_response_tool_with_parameters
