...
T = TypeVar("T", bound="ResourcesResponseToolProviderWithConfiguration")


@_attrs_define
class ResourcesResponseToolProviderWithConfiguration:
    """
    Attributes:
        resources (list[Any]): Array of resources in current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        resources = cast(list[Any], d.pop("resources"))
        ...
        resources_response_tool_provider_with_configuration = cls(
            resources=resources,
            next_=next_,
            prev=prev,
            total=total,
        ...
        resources_response_tool_provider_with_configuration.additional_properties = d
        return resources_response_tool_provider_with_configuration
