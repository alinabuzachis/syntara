...
class AuditEventListResponse:
    ...
    Attributes:
        resources (list[AuditEventRead]): Array of resources in current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for resources_item_data in _resources:
            resources_item = AuditEventRead.from_dict(resources_item_data)
