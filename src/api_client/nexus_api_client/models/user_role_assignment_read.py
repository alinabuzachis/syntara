...
T = TypeVar("T", bound="UserRoleAssignmentRead")


@_attrs_define
class UserRoleAssignmentRead:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_role_assignment_read.additional_properties = d
        return user_role_assignment_read
