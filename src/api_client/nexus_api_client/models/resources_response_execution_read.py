...
T = TypeVar("T", bound="ResourcesResponseExecutionRead")


@_attrs_define
class ResourcesResponseExecutionRead:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resources_response_execution_read = cls(
            resources=resources,
            next_=next_,
            prev=prev,
            total=total,
        ...
        resources_response_execution_read.additional_properties = d
        return resources_response_execution_read
