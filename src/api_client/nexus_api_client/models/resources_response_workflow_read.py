...
T = TypeVar("T", bound="ResourcesResponseWorkflowRead")


@_attrs_define
class ResourcesResponseWorkflowRead:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resources_response_workflow_read = cls(
            resources=resources,
            next_=next_,
            prev=prev,
            total=total,
        ...
        resources_response_workflow_read.additional_properties = d
        return resources_response_workflow_read
