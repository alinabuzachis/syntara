...
T = TypeVar("T", bound="InvocationListResponse")


@_attrs_define
class InvocationListResponse:
    """Paginated list response for invocations.

    Attributes:
        resources (list[Invocation]): Array of resources in current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for resources_item_data in _resources:
            resources_item = Invocation.from_dict(resources_item_data)
        ...
        invocation_list_response.additional_properties = d
        return invocation_list_response
