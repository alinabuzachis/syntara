...
class TestTextConverterErrorHandling:
    ...
    @pytest.mark.asyncio
    @patch(
        "nexus.agent_orchestrator.context_manager.file_manager.document_conversion.converters.text_converter.TextConverter._decode_text_content"
    )
    ...
    @pytest.mark.asyncio
    @patch(
        "nexus.agent_orchestrator.context_manager.file_manager.document_conversion.converters.text_converter.TextConverter._convert_to_markdown"
    )
