...
class TestLabelFilteringSQLAlchemy:
    ...
    def test_apply_label_filters_empty_filters(self, session) -> None:
    ...
    def test_apply_label_filters_single_label_match(self, session) -> None:
    ...
    def test_apply_label_filters_multiple_labels_and_logic(self, session) -> None:
    ...
    def test_apply_label_filters_team_and_service_match(self, session) -> None:
    ...
    def test_apply_label_filters_no_matches(self, session) -> None:
    ...
    def test_apply_label_filters_single_unique_label(self, session) -> None:
    ...
    def test_apply_label_filters_version_pattern(self, session) -> None:
    ...
    def test_apply_label_filters_with_order_by(self, session) -> None:
    ...
    def test_apply_label_filters_with_limit(self, session) -> None:
    ...
    def test_apply_label_filters_model_without_labels_field(self) -> None:
    ...
    def test_apply_label_filters_case_sensitive_matching(self, session) -> None:
    ...
    def test_apply_label_filters_with_parsed_params(self, session) -> None:
    ...
    def test_apply_label_filters_complex_scenario(self, session) -> None:
    ...
    def test_apply_label_filters_with_mock_query(self) -> None:
    ...
    def test_apply_label_filters_performance_with_many_labels(self, session) -> None:
        ...
        resource_with_many_labels = ResourceModel(
            ...
            created_at=datetime(2025, 1, 6, 15, 0, 0, tzinfo=UTC),
        )
    ...
    def test_apply_label_filters_json_field_operations(self, session) -> None:
        """Test that the function uses proper JSON field operations."""
        query = select(ResourceModel)
        label_filters = {"environment": "production"}

        # This should work with SQLite's JSON support
        filtered_query = apply_label_filters(query, label_filters, ResourceModel)
        result = session.exec(filtered_query).all()
