...
class TestGroupsPatchContract:
    ...
    @pytest.mark.asyncio
    async def test_update_group_name_success(self, auth_client: AsyncClient, test_group: Group) -> None:
        """Test successful group name update returns 200."""
        patch_data = {"name": "updated-name"}

        response = await auth_client.patch(f"{GROUPS_URL}/{test_group.id}", json=patch_data)
    ...
    @pytest.mark.asyncio
    async def test_update_group_description_success(self, auth_client: AsyncClient, test_group: Group) -> None:
    ...
    @pytest.mark.asyncio
    async def test_update_group_preserves_unchanged_fields(self, auth_client: AsyncClient, test_group: Group) -> None:
    ...
    @pytest.mark.asyncio
    async def test_update_group_empty_patch(self, auth_client: AsyncClient, test_group: Group) -> None:
    ...
    @pytest.mark.asyncio
    async def test_update_group_updates_timestamp(self, auth_client: AsyncClient, test_group: Group) -> None:
    ...
    @pytest.mark.asyncio
    async def test_update_group_name_conflict(self, auth_client: AsyncClient, test_group: Group) -> None:
        """Test 409 conflict when updating to an existing group name."""
        # Create another group
        create_response = await auth_client.post(GROUPS_URL, json={"name": "existing-name"})
    ...
    @pytest.mark.asyncio
    async def test_update_group_not_found(self, auth_client: AsyncClient) -> None:
        """Test 404 error for non-existent group."""
        group_id = "99999999-9999-9999-9999-999999999999"
        patch_data = {"name": "new-name"}

        response = await auth_client.patch(f"{GROUPS_URL}/{group_id}", json=patch_data)

        assert response.status_code == 404

    @pytest.mark.asyncio
    async def test_update_group_name_too_long(self, auth_client: AsyncClient, test_group: Group) -> None:
    ...
    @pytest.mark.asyncio
    async def test_update_group_description_too_long(self, auth_client: AsyncClient, test_group: Group) -> None:
    ...
    @pytest.mark.asyncio
    async def test_update_group_null_description_is_noop(self, auth_client: AsyncClient, test_group: Group) -> None:
    ...
    @pytest.mark.asyncio
    async def test_update_group_both_fields(self, auth_client: AsyncClient, test_group: Group) -> None:
    ...
    @pytest.mark.asyncio
    async def test_update_group_same_name_no_conflict(self, auth_client: AsyncClient, test_group: Group) -> None:
