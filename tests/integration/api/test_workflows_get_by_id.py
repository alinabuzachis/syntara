...
@pytest.mark.asyncio
async def test_get_workflow_by_valid_id(jwt_client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_get_workflow_by_nonexistent_id(jwt_client: AsyncClient) -> None:
    """Test retrieving a workflow with non-existent ID.

    Expected: 404 Not Found
    """
    fake_id = "00000000-0000-0000-0000-000000000000"
    response = await jwt_client.get(f"/api/v1/workflows/{fake_id}")
...
@pytest.mark.asyncio
async def test_get_workflow_includes_current_version(jwt_client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_get_soft_deleted_workflow_returns_404(jwt_client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_get_workflow_response_schema(jwt_client: AsyncClient) -> None:
