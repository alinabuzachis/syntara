...
class TestGenericQueryFlow:
    ...
    async def test_information_query_routes_to_generic_agent(
        self, base_client_with_mocked_llm: AsyncClient, test_user
    ) -> None:
        ...
        # Act
        response = await base_client_with_mocked_llm.post("/api/v1/invocations", json=request_data)
    ...
    @pytest.mark.asyncio
    async def test_llm_generates_answer_for_query(self, base_client_with_mocked_llm: AsyncClient, test_user) -> None:
...
class TestGenericQueryErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_handles_llm_errors_gracefully(self, base_client_with_mocked_llm: AsyncClient, test_user) -> None:
    ...
    @pytest.mark.asyncio
    async def test_handles_invalid_request_data(self, base_client_with_mocked_llm: AsyncClient, test_user) -> None:
