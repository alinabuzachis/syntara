...
This reads OpenAPI specs from `backend/src/nexus/schemas/` and generates types in `frontend/packages/nexus-contracts/src/`. Include the regenerated types in the same PR as the schema changes.
