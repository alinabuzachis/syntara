      ...
      <Menu>
        ...
        <MenuItems>
          ...
          <MenuGroup label="Options">
            <MenuCheckboxItem checked={true} onCheckedChange={(checked) => console.log('Checkbox 1:', checked)}>
              Checkbox 1
            </MenuCheckboxItem>
            <MenuCheckboxItem checked={false} onCheckedChange={(checked) => console.log('Checkbox 2:', checked)}>
              Checkbox 2
            </MenuCheckboxItem>
          </MenuGroup>
          <MenuSeparator />
          <MenuRadioGroup value="option1" onValueChange={(value) => console.log('Selected Radio:', value)}>
