...
2. Run tests:
   ...
   NEXUS_E2E_SKIP_WEB_SERVER=1 \
     NEXUS_E2E_BASE_URL=http://localhost:8000 \
     NEXUS_E2E_PASSWORD=<admin-password> \
     npm run e2e
   ```
...
| --------------------------- | -------- | ---------------------------------------------------------------------------------------------------------------------- |
| `NEXUS_E2E_SKIP_WEB_SERVER` | Yes      | Set to `1` to skip starting the mock API and UI                                                                        |
| `NEXUS_E2E_BASE_URL`        | Yes      | URL of the running UI (e.g. `http://localhost:8000`)                                                                   |
| `NEXUS_E2E_PASSWORD`        | Yes      | Password for the `admin` user. In CI this is read from `.secrets/admin-password` generated by `make secrets-generate`. |
