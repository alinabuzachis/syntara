...
const mockAssignment: ProjectRoleAssignmentRead = {
  id: 'a1',
  user_id: 'u1',
  username: 'alice',
  project_id: 'p1',
...
describe('UnassignProjectRoleDialog', () => {
  ...
  it('falls back to user_id when username is not available', () => {
    const assignmentWithoutUsername: ProjectRoleAssignmentRead = {
      ...mockAssignment,
      username: undefined,
    }
    ...
    render(
      <UnassignProjectRoleDialog
        assignment={assignmentWithoutUsername}
        isOpen={true}
        onClose={vi.fn()}
        onConfirm={vi.fn()}
      />
