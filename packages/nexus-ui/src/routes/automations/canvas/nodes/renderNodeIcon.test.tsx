...
describe('renderNodeIcon', () => {
  ...
  it('renders custom icon with styling for aap node', () => {
    const result = renderNodeIcon(MockStyledIcon, 'aap')
    render(<>{result}</>)
  ...
  it('applies rotation transform for logic-condition node', () => {
    const result = renderNodeIcon(MockIcon, 'logic-condition')
  ...
  it('applies rotation transform for logic-converge node', () => {
    const result = renderNodeIcon(MockIcon, 'logic-converge')
    const { container } = render(<>{result}</>)
  ...
  it('applies different custom icon offset for header variant', () => {
    const result = renderNodeIcon(MockStyledIcon, 'aap', 'header')
    render(<>{result}</>)
  ...
  it('applies zero offset for canvas variant custom icon', () => {
    const result = renderNodeIcon(MockStyledIcon, 'aap', 'canvas')
    render(<>{result}</>)
  ...
  it('applies correct scale for list variant custom icon', () => {
    const result = renderNodeIcon(MockStyledIcon, 'aap', 'list')
    render(<>{result}</>)
