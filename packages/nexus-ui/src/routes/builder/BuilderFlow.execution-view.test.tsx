      ...
      currentWorkflow: {
        ...
        workflow: {
          activities: [
            ...
            { id: 'loop-1', type: 'loop', config: { type: 'for_each', items: '' } },
            {
              id: 'task-1',
              type: 'script',
              name: 'Task 1',
              config: { language: 'bash', code: 'echo 1' },
            },
            {
              id: 'task-generic',
              type: 'script',
              ...
              config: { language: 'bash', code: 'echo generic' },
            },
            {
              id: 'task-approval',
              type: 'approval',
              name: 'Approval Task',
              config: { approvers: ['admin'], prompt: 'Approve' },
            },
            {
              id: 'task-loop-body',
              type: 'script',
              name: 'Loop Body',
              config: { language: 'bash', code: 'echo loop' },
            },
          ],
        },
      },
