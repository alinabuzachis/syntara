...
export const integrations: IntegrationRead[] = [
  {
    ...
    scope: 'global',
    configuration: { integration_type: IntegrationTypeEnum.MCP_SERVER, base_url: 'https://mcp.github.com' },
  ...
  },
  {
    ...
    validation_status: IntegrationStatusEnum.AVAILABLE,
    scope: 'global',
    configuration: { integration_type: IntegrationTypeEnum.MCP_SERVER, base_url: 'https://mcp.slack.com' },
    management_credential_id: null,
  ...
  },
  {
    ...
    scope: 'global',
    configuration: { integration_type: IntegrationTypeEnum.MCP_SERVER, base_url: 'https://mcp.atlassian.com' },
    management_credential_id: null,
  ...
  },
  {
    ...
    scope: 'global',
    configuration: { integration_type: IntegrationTypeEnum.MCP_SERVER, base_url: 'https://mcp.servicenow.com' },
    management_credential_id: null,
  ...
  },
  {
    ...
    validation_status: IntegrationStatusEnum.AVAILABLE,
    scope: 'global',
    configuration: { integration_type: IntegrationTypeEnum.MCP_SERVER, base_url: 'https://mcp.pagerduty.com' },
    management_credential_id: null,
