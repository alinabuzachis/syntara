...
def nexus_client(nexus_base_url: str) -> AuthenticatedClient:
    ...
    from nexus_api_client import AuthenticatedClient  # noqa: PLC0415
...
def nexus_api(nexus_base_url: str, nexus_client: AuthenticatedClient) -> NexusApiRegistry:
    ...
    from nexus_api_client import AuthenticatedClient  # noqa: PLC0415
    from nexus_api_client.api import NexusApiRegistry  # noqa: PLC0415
    from nexus_api_client.api.internal_metrics import InternalMetricsApi  # noqa: PLC0415
