...
Registered as a pytest plugin via nexus_test_sdk.plugin.pytest_plugins.
Kept separate from nexus_test_sdk.app.__init__ so that importing any
nexus_test_sdk.app submodule (e.g. mcp_servers) from a non-test context
does not pull in pytest or the nexus package.
"""
