...
class TestWorkflowVersionListing:
    ...
    def test_list_workflow_versions(self, nexus_api: NexusApiRegistry, workflow_factory: WorkflowFactory) -> None:
    ...
    def test_list_versions_nonexistent_workflow(self, nexus_api: NexusApiRegistry) -> None:
        ...
        """
        fake_id = uuid4()
        response = nexus_api.workflows.list_versions(workflow_id=fake_id)
...
class TestWorkflowVersionRetrieval:
    ...
    def test_get_nonexistent_version(self, nexus_api: NexusApiRegistry, workflow_factory: WorkflowFactory) -> None:
        ...
        response = nexus_api.workflows.get_version(workflow_id=workflow_id, version=99)
    ...
    def test_get_version_nonexistent_workflow(self, nexus_api: NexusApiRegistry) -> None:
        ...
        """
        fake_id = uuid4()
        response = nexus_api.workflows.get_version(workflow_id=fake_id, version=1)

        assert response.status_code == HTTPStatus.NOT_FOUND

    def test_get_version_response_schema(self, nexus_api: NexusApiRegistry, workflow_factory: WorkflowFactory) -> None:
