...
class TestToolProvidersPatchContract:
    ...
    async def test_patch_provider_success_contract(
        ...
        response = await jwt_client_with_provider_factory.patch(
    ...
    @pytest.mark.asyncio
    async def test_patch_provider_not_found_contract(self, jwt_client_with_provider_factory: AsyncClient) -> None:
    ...
    async def test_patch_provider_integrity_error_non_name_conflict_contract(
        self, jwt_client_with_provider_factory: AsyncClient, test_tool_provider: ToolProvider, monkeypatch
    ) -> None:
