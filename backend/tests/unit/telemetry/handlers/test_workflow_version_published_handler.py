...
from nexus.telemetry.handlers.workflow_version_published import WorkflowVersionPublishedTelemetryHandler
from nexus.workflows.audit.workflow_version import WorkflowVersionPublishedEvent


class TestWorkflowVersionPublishedTelemetryHandler:
    """Tests for the WorkflowVersionPublishedTelemetryHandler."""

    @patch("nexus.telemetry.handlers.workflow_version_published.get_telemetry_registry")
