...
import nexus.integrations.adapters.aap
import nexus.integrations.adapters.llm_provider
import nexus.integrations.adapters.mcp_server  # noqa: F401 — register adapters in the worker process
...
from nexus.integrations.models import Integration
from nexus.integrations.models.integration import IntegrationRefreshStatus, IntegrationType
