...
@fastapi_exception(handler="nexus.credentials.error_handlers.credential_error_handler")
class CredentialError(NexusError):
    """Base exception for all credential management errors."""


@fastapi_exception(handler="nexus.credentials.error_handlers.credential_not_found_handler")
class CredentialNotFoundError(CredentialError):
    """Exception raised when a credential is not found."""


@fastapi_exception(handler="nexus.credentials.error_handlers.credential_name_conflict_handler")
...
@fastapi_exception(handler="nexus.credentials.error_handlers.credential_decryption_error_handler")
