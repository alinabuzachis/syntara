...
- A :class:`~nexus.core.workers.periodic.PeriodicWorker` polls for
...
class SettingsCache:
    ...
    async def _try_acquire_redis_client(self) -> None:
        ...
        from nexus.core.cache.settings_client import SettingsRedisClient  # noqa: PLC0415
    ...
    def start_watching(self) -> None:
        ...
        Always starts a :class:`~nexus.core.workers.periodic.PeriodicWorker`
        ...
        from nexus.settings.watch import _apply_watchers  # noqa: PLC0415
    ...
    async def _start_watching_async(self) -> None:
        ...
        try:
            ...
            from nexus.core.workers.periodic import PeriodicWorker  # noqa: PLC0415
    ...
    async def publish_change(self, key: str) -> None:
        ...
        Called by
        :class:`~nexus.settings.services.settings_service.SettingsService`
