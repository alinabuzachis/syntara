...
from ...models.project_policy_create import ProjectPolicyCreate
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ErrorData | PolicyRead | None:
    if response.status_code == 201:
        response_201 = PolicyRead.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        project_id (UUID):
        body (ProjectPolicyCreate): Request body for creating a project-scoped policy (project_id
            comes from URL path).
