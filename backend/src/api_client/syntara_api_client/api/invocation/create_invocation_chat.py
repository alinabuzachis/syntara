...
from ...models.invocation_request_with_file import InvocationRequestWithFile
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ErrorData | Invocation | None:
...
def sync_detailed(
    *,
    ...
    Args:
        body (InvocationRequestWithFile): Multipart form body for POST /invocations/chat (file
            upload path).
