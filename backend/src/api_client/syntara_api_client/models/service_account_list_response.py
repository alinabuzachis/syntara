...
T = TypeVar("T", bound="ServiceAccountListResponse")
...
class ServiceAccountListResponse:
    ...
    Attributes:
        resources (list[ServiceAccountRead]): Array of resources in current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for resources_item_data in _resources:
            resources_item = ServiceAccountRead.from_dict(resources_item_data)
        ...
        return service_account_list_response
