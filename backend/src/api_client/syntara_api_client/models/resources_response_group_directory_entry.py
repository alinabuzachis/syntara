...
if TYPE_CHECKING:
    from ..models.group_directory_entry import GroupDirectoryEntry


T = TypeVar("T", bound="ResourcesResponseGroupDirectoryEntry")


@_attrs_define
class ResourcesResponseGroupDirectoryEntry:
    """
    Attributes:
        resources (list[GroupDirectoryEntry]): Array of resources in current page
    ...
    resources: list[GroupDirectoryEntry]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for resources_item_data in _resources:
            resources_item = GroupDirectoryEntry.from_dict(resources_item_data)
        ...
        resources_response_group_directory_entry = cls(
            resources=resources,
            next_=next_,
            prev=prev,
            total=total,
        ...
        resources_response_group_directory_entry.additional_properties = d
        return resources_response_group_directory_entry
