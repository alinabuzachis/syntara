...
T = TypeVar("T", bound="ActivityExecutionListResponse")


@_attrs_define
class ActivityExecutionListResponse:
    """Paginated list response for activity executions.

    Attributes:
        resources (list[ActivityExecution]): Array of resources in current page
    ...
    resources: list[ActivityExecution]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for resources_item_data in _resources:
            resources_item = ActivityExecution.from_dict(resources_item_data)
        ...
        activity_execution_list_response = cls(
            resources=resources,
            next_=next_,
            prev=prev,
            total=total,
        ...
        activity_execution_list_response.additional_properties = d
        return activity_execution_list_response
