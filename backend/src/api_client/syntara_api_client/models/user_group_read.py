...
if TYPE_CHECKING:
    ...
    from ..models.user_group_read_labels import UserGroupReadLabels
...
class UserGroupRead:
    ...
    Attributes:
        ...
        labels (UserGroupReadLabels | Unset): Key-value pairs for resource labeling and filtering Example:
    ...
    labels: UserGroupReadLabels | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        labels: UserGroupReadLabels | Unset
        if isinstance(_labels, Unset):
            labels = UNSET
        else:
            labels = UserGroupReadLabels.from_dict(_labels)
