...
if TYPE_CHECKING:
    from ..models.api_executor_parameters import APIExecutorParameters
    from ..models.http_request_node_outputs_type_0 import HTTPRequestNodeOutputsType0
    from ..models.node_position import NodePosition
    from ..models.node_settings_full import NodeSettingsFull


T = TypeVar("T", bound="HTTPRequestNode")
...
class HTTPRequestNode:
    ...
    Attributes:
        ...
        type_ (Literal['http_request']):
        parameters (APIExecutorParameters): Parameters for API executor (http_request activity).
        ...
        outputs (HTTPRequestNodeOutputsType0 | None | Unset): Output extraction mapping
    ...
    outputs: HTTPRequestNodeOutputsType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.outputs, Unset):
            outputs = UNSET
        elif isinstance(self.outputs, HTTPRequestNodeOutputsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["http_request"], d.pop("type"))
        if type_ != "http_request":
            raise ValueError(f"type must match const 'http_request', got '{type_}'")

        parameters = APIExecutorParameters.from_dict(d.pop("parameters"))
        ...
        def _parse_outputs(data: object) -> HTTPRequestNodeOutputsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                outputs_type_0 = HTTPRequestNodeOutputsType0.from_dict(data)

                return outputs_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(HTTPRequestNodeOutputsType0 | None | Unset, data)
        ...
        http_request_node.additional_properties = d
