...
T = TypeVar("T", bound="ApprovalListResponse")
...
class ApprovalListResponse:
    ...
    Attributes:
        resources (list[ApprovalRequestRead]): Array of resources in current page
    ...
    resources: list[ApprovalRequestRead]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for resources_item_data in _resources:
            resources_item = ApprovalRequestRead.from_dict(resources_item_data)
        ...
        approval_list_response.additional_properties = d
        return approval_list_response
