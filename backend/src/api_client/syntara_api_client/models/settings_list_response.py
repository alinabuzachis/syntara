...
T = TypeVar("T", bound="SettingsListResponse")
...
class SettingsListResponse:
    ...
    Attributes:
        resources (list[RuntimeSettingRead]): Array of resources in current page
    ...
    resources: list[RuntimeSettingRead]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for resources_item_data in _resources:
            resources_item = RuntimeSettingRead.from_dict(resources_item_data)
        ...
        settings_list_response.additional_properties = d
        return settings_list_response
