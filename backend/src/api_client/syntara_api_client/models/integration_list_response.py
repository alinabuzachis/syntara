...
T = TypeVar("T", bound="IntegrationListResponse")
...
class IntegrationListResponse:
    ...
    Attributes:
        resources (list[IntegrationRead]): Array of resources in current page
    ...
    resources: list[IntegrationRead]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for resources_item_data in _resources:
            resources_item = IntegrationRead.from_dict(resources_item_data)
        ...
        integration_list_response.additional_properties = d
        return integration_list_response
