...
class ToolListResponse:
    ...
    Attributes:
        resources (list[ToolWithParameters]): Array of resources in current page
    ...
    resources: list[ToolWithParameters]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for resources_item_data in _resources:
            resources_item = ToolWithParameters.from_dict(resources_item_data)
