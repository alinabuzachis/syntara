...
if TYPE_CHECKING:
    from ..models.user_directory_entry import UserDirectoryEntry


T = TypeVar("T", bound="ResourcesResponseUserDirectoryEntry")


@_attrs_define
class ResourcesResponseUserDirectoryEntry:
    """
    Attributes:
        resources (list[UserDirectoryEntry]): Array of resources in current page
    ...
    resources: list[UserDirectoryEntry]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for resources_item_data in _resources:
            resources_item = UserDirectoryEntry.from_dict(resources_item_data)
        ...
        resources_response_user_directory_entry = cls(
            resources=resources,
            next_=next_,
            prev=prev,
            total=total,
        ...
        resources_response_user_directory_entry.additional_properties = d
        return resources_response_user_directory_entry
