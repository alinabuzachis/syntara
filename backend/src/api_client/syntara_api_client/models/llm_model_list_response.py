...
if TYPE_CHECKING:
    from ..models.llm_model_read import LLMModelRead


T = TypeVar("T", bound="LLMModelListResponse")
...
class LLMModelListResponse:
    ...
    Attributes:
        resources (list[LLMModelRead]): Array of resources in current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for resources_item_data in _resources:
            resources_item = LLMModelRead.from_dict(resources_item_data)
        ...
        llm_model_list_response.additional_properties = d
        return llm_model_list_response
