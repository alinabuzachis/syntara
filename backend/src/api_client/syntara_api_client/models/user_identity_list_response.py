...
T = TypeVar("T", bound="UserIdentityListResponse")
...
class UserIdentityListResponse:
    ...
    Attributes:
        resources (list[UserIdentityRead]): Array of resources in current page
    ...
    resources: list[UserIdentityRead]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for resources_item_data in _resources:
            resources_item = UserIdentityRead.from_dict(resources_item_data)
        ...
        user_identity_list_response = cls(
            resources=resources,
            next_=next_,
            prev=prev,
            total=total,
        ...
        user_identity_list_response.additional_properties = d
        return user_identity_list_response
