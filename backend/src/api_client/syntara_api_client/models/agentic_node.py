...
if TYPE_CHECKING:
    from ..models.agentic_executor_parameters import AgenticExecutorParameters
    from ..models.agentic_node_outputs_type_0 import AgenticNodeOutputsType0
    from ..models.node_position import NodePosition
    from ..models.node_settings_no_retry import NodeSettingsNoRetry


T = TypeVar("T", bound="AgenticNode")
...
class AgenticNode:
    ...
    Attributes:
        ...
        type_ (Literal['agentic']):
        parameters (AgenticExecutorParameters): Parameters for agentic executor.
        ...
        outputs (AgenticNodeOutputsType0 | None | Unset): Output extraction mapping
    ...
    outputs: AgenticNodeOutputsType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.outputs, Unset):
            outputs = UNSET
        elif isinstance(self.outputs, AgenticNodeOutputsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["agentic"], d.pop("type"))
        if type_ != "agentic":
            raise ValueError(f"type must match const 'agentic', got '{type_}'")

        parameters = AgenticExecutorParameters.from_dict(d.pop("parameters"))
        ...
        def _parse_outputs(data: object) -> AgenticNodeOutputsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                outputs_type_0 = AgenticNodeOutputsType0.from_dict(data)

                return outputs_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AgenticNodeOutputsType0 | None | Unset, data)
        ...
        agentic_node.additional_properties = d
        return agentic_node
