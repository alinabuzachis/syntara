...
if TYPE_CHECKING:
    from ..models.approval_node_outputs_type_0 import ApprovalNodeOutputsType0
    from ..models.approval_node_parameters import ApprovalNodeParameters
    from ..models.node_position import NodePosition
    from ..models.node_settings_no_retry import NodeSettingsNoRetry


T = TypeVar("T", bound="ApprovalNode")
...
class ApprovalNode:
    ...
    Attributes:
        ...
        type_ (Literal['approval']):
        parameters (ApprovalNodeParameters): Parameters for approval gate nodes.
        ...
        outputs (ApprovalNodeOutputsType0 | None | Unset): Output extraction mapping
    ...
    outputs: ApprovalNodeOutputsType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.outputs, Unset):
            outputs = UNSET
        elif isinstance(self.outputs, ApprovalNodeOutputsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["approval"], d.pop("type"))
        if type_ != "approval":
            raise ValueError(f"type must match const 'approval', got '{type_}'")

        parameters = ApprovalNodeParameters.from_dict(d.pop("parameters"))
        ...
        def _parse_outputs(data: object) -> ApprovalNodeOutputsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                outputs_type_0 = ApprovalNodeOutputsType0.from_dict(data)

                return outputs_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ApprovalNodeOutputsType0 | None | Unset, data)
        ...
        approval_node.additional_properties = d
