...
T = TypeVar("T", bound="ToolProviderCreate")


@_attrs_define
class ToolProviderCreate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tool_provider_create = cls(
            name=name,
            configuration=configuration,
            description=description,
        )

        tool_provider_create.additional_properties = d
        return tool_provider_create
