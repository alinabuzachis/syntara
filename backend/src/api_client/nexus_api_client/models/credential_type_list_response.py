...
T = TypeVar("T", bound="CredentialTypeListResponse")


@_attrs_define
class CredentialTypeListResponse:
    """Paginated list response for credential types.

    Attributes:
        resources (list[CredentialTypeRead]): Array of resources in current page
    ...
    resources: list[CredentialTypeRead]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for resources_item_data in _resources:
            resources_item = CredentialTypeRead.from_dict(resources_item_data)
        ...
        credential_type_list_response = cls(
            resources=resources,
            next_=next_,
            prev=prev,
            total=total,
        ...
        credential_type_list_response.additional_properties = d
        return credential_type_list_response
