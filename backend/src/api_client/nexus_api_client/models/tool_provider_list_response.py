...
T = TypeVar("T", bound="ToolProviderListResponse")


@_attrs_define
class ToolProviderListResponse:
    """Paginated list response for tool providers.

    Attributes:
        resources (list[ToolProviderWithConfiguration]): Array of resources in current page
    ...
    resources: list[ToolProviderWithConfiguration]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for resources_item_data in _resources:
            resources_item = ToolProviderWithConfiguration.from_dict(resources_item_data)
        ...
        tool_provider_list_response = cls(
            resources=resources,
            next_=next_,
            prev=prev,
            total=total,
        ...
        tool_provider_list_response.additional_properties = d
        return tool_provider_list_response
