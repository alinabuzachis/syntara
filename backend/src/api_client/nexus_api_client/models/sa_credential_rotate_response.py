...
T = TypeVar("T", bound="SACredentialRotateResponse")


@_attrs_define
class SACredentialRotateResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sa_credential_rotate_response = cls(
            id=id,
            service_account_id=service_account_id,
            credential_type=credential_type,
            identifier=identifier,
        ...
        sa_credential_rotate_response.additional_properties = d
        return sa_credential_rotate_response
