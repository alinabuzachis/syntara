...
if TYPE_CHECKING:
    from ..models.aap_workflow_job_template_executor_parameters import AAPWorkflowJobTemplateExecutorParameters
    from ..models.aap_workflow_job_template_node_outputs_type_0 import AAPWorkflowJobTemplateNodeOutputsType0
    from ..models.node_position import NodePosition
    from ..models.node_settings_full import NodeSettingsFull


T = TypeVar("T", bound="AAPWorkflowJobTemplateNode")


@_attrs_define
class AAPWorkflowJobTemplateNode:
    """Ansible Automation Platform workflow job template executor node.

    Attributes:
        id (str): Unique identifier for the node within the workflow
        type_ (Literal['aap_workflow_job_template']):
        parameters (AAPWorkflowJobTemplateExecutorParameters): Parameters for Ansible Automation Platform Workflow Job
            Template executor.
        ...
        outputs (AAPWorkflowJobTemplateNodeOutputsType0 | None | Unset): Output extraction mapping
    ...
    outputs: AAPWorkflowJobTemplateNodeOutputsType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.outputs, Unset):
            outputs = UNSET
        elif isinstance(self.outputs, AAPWorkflowJobTemplateNodeOutputsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["aap_workflow_job_template"], d.pop("type"))
        if type_ != "aap_workflow_job_template":
            raise ValueError(f"type must match const 'aap_workflow_job_template', got '{type_}'")

        parameters = AAPWorkflowJobTemplateExecutorParameters.from_dict(d.pop("parameters"))
        ...
        def _parse_outputs(data: object) -> AAPWorkflowJobTemplateNodeOutputsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                outputs_type_0 = AAPWorkflowJobTemplateNodeOutputsType0.from_dict(data)

                return outputs_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AAPWorkflowJobTemplateNodeOutputsType0 | None | Unset, data)
        ...
        aap_workflow_job_template_node = cls(
            id=id,
            type_=type_,
            parameters=parameters,
            name=name,
        ...
        aap_workflow_job_template_node.additional_properties = d
        return aap_workflow_job_template_node
