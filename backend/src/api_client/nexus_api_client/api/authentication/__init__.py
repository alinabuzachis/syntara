...
class AuthenticationApi:
    ...
    def create_ws_ticket(self, **kwargs: Any) -> Response[Any]:
        endpoint_module = self._load_endpoint_module("create_ws_ticket")
        return endpoint_module.sync_detailed(client=self._client, **kwargs)

    async def async_create_ws_ticket(self, **kwargs: Any) -> Response[Any]:
        endpoint_module = self._load_endpoint_module("create_ws_ticket")
        return await endpoint_module.asyncio_detailed(client=self._client, **kwargs)
