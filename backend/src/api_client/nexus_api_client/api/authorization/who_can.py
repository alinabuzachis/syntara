...
from ...models.who_can_request import WhoCanRequest
from ...models.who_can_response import WhoCanResponse
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = WhoCanResponse.from_dict(response.json())
