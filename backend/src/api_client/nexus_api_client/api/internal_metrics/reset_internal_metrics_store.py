...
from ...models.reset_internal_metrics_store_response_reset_internal_metrics_store import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ResetInternalMetricsStoreResponseResetInternalMetricsStore.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        ErrorData | ResetInternalMetricsStoreResponseResetInternalMetricsStore
    """
