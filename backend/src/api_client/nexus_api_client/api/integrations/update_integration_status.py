...
from ...models.integration_status_patch import IntegrationStatusPatch
...
def _get_kwargs(
    integration_id: UUID,
    *,
    body: IntegrationStatusPatch,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/integrations/{integration_id}/status",
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        integration_id (UUID):
        body (IntegrationStatusPatch): Schema for service-to-service status updates (not user-
            facing).
