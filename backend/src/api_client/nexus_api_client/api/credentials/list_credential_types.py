...
from ...models.credential_type_list_response import CredentialTypeListResponse
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CredentialTypeListResponse.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        CredentialTypeListResponse | ErrorData
    """
